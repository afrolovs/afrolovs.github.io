...
gdjs.evtsExt__Custom_Extension__ShowRightButton.asyncCallback19664916 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.3), (runtimeScene) => (gdjs.evtsExt__Custom_Extension__ShowRightButton.asyncCallback19664916(runtimeScene, eventsFunctionContext, asyncObjectsList)));
}
}
...
{isConditionTrue_0 = eventsFunctionContext.getOnceTriggers().triggerOnce(19715324);
}
