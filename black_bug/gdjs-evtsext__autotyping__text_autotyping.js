...
gdjs.evtsExt__AutoTyping__Text_AutoTyping.Text_AutoTyping = class Text_AutoTyping extends gdjs.RuntimeBehavior {
  constructor(instanceContainer, behaviorData, owner) {
    ...
    this._behaviorData.PlaySound = behaviorData.PlaySound !== undefined ? behaviorData.PlaySound : false;
  }
  ...
  updateFromBehaviorData(oldBehaviorData, newBehaviorData) {
    ...
    if (oldBehaviorData.PlaySound !== newBehaviorData.PlaySound)
      this._behaviorData.PlaySound = newBehaviorData.PlaySound;
  ...
  _getPlaySound() {
    return this._behaviorData.PlaySound !== undefined ? this._behaviorData.PlaySound : false;
  }
  _setPlaySound(newValue) {
    this._behaviorData.PlaySound = newValue;
  }
  _togglePlaySound() {
    this._setPlaySound(!this._getPlaySound());
  }
}
...
for (var i = 0, k = 0, l = gdjs.evtsExt__AutoTyping__Text_AutoTyping.Text_AutoTyping.prototype.doStepPostEventsContext.GDObjectObjects2.length;i<l;++i) {
    if ( gdjs.evtsExt__AutoTyping__Text_AutoTyping.Text_AutoTyping.prototype.doStepPostEventsContext.GDObjectObjects2[i].getBehavior(eventsFunctionContext.getBehaviorName("Behavior"))._getPlaySound() ) {
...
{gdjs.evtTools.sound.playSound(runtimeScene, "key.AAC", false, 40, gdjs.randomFloatInRange(0.8, 1.2));
}}
...
{ //Subevents
gdjs.evtsExt__AutoTyping__Text_AutoTyping.Text_AutoTyping.prototype.doStepPostEventsContext.eventsList3(runtimeScene, eventsFunctionContext);} //End of subevents
}

}


};gdjs.evtsExt__AutoTyping__Text_AutoTyping.Text_AutoTyping.prototype.doStepPostEventsContext.eventsList5 = function(runtimeScene, eventsFunctionContext) {
...
gdjs.evtsExt__AutoTyping__Text_AutoTyping.Text_AutoTyping.prototype.doStepPostEventsContext.eventsList5(runtimeScene, eventsFunctionContext);
...
{for(var i = 0, len = gdjs.evtsExt__AutoTyping__Text_AutoTyping.Text_AutoTyping.prototype.StartAtBeginningContext.GDObjectObjects1.length ;i < len;++i) {
    gdjs.evtsExt__AutoTyping__Text_AutoTyping.Text_AutoTyping.prototype.StartAtBeginningContext.GDObjectObjects1[i].returnVariable(gdjs.evtsExt__AutoTyping__Text_AutoTyping.Text_AutoTyping.prototype.StartAtBeginningContext.GDObjectObjects1[i].getVariables().get("__AutoTyping").getChild("txt_buffer")).setString((gdjs.evtsExt__AutoTyping__Text_AutoTyping.Text_AutoTyping.prototype.StartAtBeginningContext.GDObjectObjects1[i].getBehavior(eventsFunctionContext.getBehaviorName("Text")).getText()));
}
}{for(var i = 0, len = gdjs.evtsExt__AutoTyping__Text_AutoTyping.Text_AutoTyping.prototype.StartAtBeginningContext.GDObjectObjects1.length ;i < len;++i) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = eventsFunctionContext.getOnceTriggers().triggerOnce(20298324);
}
if (isConditionTrue_0) {
