...
gdjs.YouWinCode.asyncCallback21679220 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.YouWinCode.asyncCallback21679220(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.YouWinCode.asyncCallback21678812 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.YouWinCode.asyncCallback21678812(runtimeScene, asyncObjectsList)));
}
}
...
gdjs.YouWinCode.asyncCallback21680900 = function (runtimeScene, asyncObjectsList) {
...
{
const asyncObjectsList = gdjs.LongLivedObjectsList.from(parentAsyncObjectsList);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1.5), (runtimeScene) => (gdjs.YouWinCode.asyncCallback21680900(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.YouWinCode.asyncCallback21681220 = function (runtimeScene, asyncObjectsList) {
...
{
const asyncObjectsList = new gdjs.LongLivedObjectsList();
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(3.5), (runtimeScene) => (gdjs.YouWinCode.asyncCallback21681220(runtimeScene, asyncObjectsList)));
}
}
...
gdjs.YouWinCode.asyncCallback21689988 = function (runtimeScene, asyncObjectsList) {
...
{
const asyncObjectsList = gdjs.LongLivedObjectsList.from(parentAsyncObjectsList);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(4), (runtimeScene) => (gdjs.YouWinCode.asyncCallback21689988(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.YouWinCode.asyncCallback21688500 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1.5), (runtimeScene) => (gdjs.YouWinCode.asyncCallback21688500(runtimeScene, asyncObjectsList)));
}
}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(21688268);
}
if (isConditionTrue_0) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(21681148);
}
if (isConditionTrue_0) {
...
};gdjs.YouWinCode.asyncCallback21691444 = function (runtimeScene, asyncObjectsList) {
...
{
const asyncObjectsList = new gdjs.LongLivedObjectsList();
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.YouWinCode.asyncCallback21691444(runtimeScene, asyncObjectsList)));
}
}
