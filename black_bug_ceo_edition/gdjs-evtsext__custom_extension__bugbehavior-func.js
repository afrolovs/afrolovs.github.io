...
gdjs.evtsExt__Custom_Extension__BugBehavior.asyncCallback20356028 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.evtsExt__Custom_Extension__BugBehavior.asyncCallback20356028(runtimeScene, eventsFunctionContext, asyncObjectsList)));
}
}
