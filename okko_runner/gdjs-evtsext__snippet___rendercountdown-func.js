...
gdjs.evtsExt__Snippet___RenderCountdown.asyncCallback13525548 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.3), (runtimeScene) => (gdjs.evtsExt__Snippet___RenderCountdown.asyncCallback13525548(runtimeScene, eventsFunctionContext, asyncObjectsList)));
}
}
...
{isConditionTrue_0 = eventsFunctionContext.getOnceTriggers().triggerOnce(13523972);
}
