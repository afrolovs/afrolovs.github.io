...
gdjs.evtsExt__Snippet__BGSlideSportPosters.asyncCallback13099876 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(eventsFunctionContext.localVariables[0].getFromIndex(0).getAsNumber() * 2), (runtimeScene) => (gdjs.evtsExt__Snippet__BGSlideSportPosters.asyncCallback13099876(runtimeScene, eventsFunctionContext, asyncObjectsList)));
}
}
...
};gdjs.evtsExt__Snippet__BGSlideSportPosters.asyncCallback13098764 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(eventsFunctionContext.localVariables);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(eventsFunctionContext.localVariables[0].getFromIndex(0).getAsNumber()), (runtimeScene) => (gdjs.evtsExt__Snippet__BGSlideSportPosters.asyncCallback13098764(runtimeScene, eventsFunctionContext, asyncObjectsList)));
}
}
...
};gdjs.evtsExt__Snippet__BGSlideSportPosters.asyncCallback13098284 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(eventsFunctionContext.localVariables);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(eventsFunctionContext.localVariables[0].getFromIndex(0).getAsNumber()), (runtimeScene) => (gdjs.evtsExt__Snippet__BGSlideSportPosters.asyncCallback13098284(runtimeScene, eventsFunctionContext, asyncObjectsList)));
}
}
...
};gdjs.evtsExt__Snippet__BGSlideSportPosters.asyncCallback13098692 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(eventsFunctionContext.localVariables);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(eventsFunctionContext.localVariables[0].getFromIndex(0).getAsNumber()), (runtimeScene) => (gdjs.evtsExt__Snippet__BGSlideSportPosters.asyncCallback13098692(runtimeScene, eventsFunctionContext, asyncObjectsList)));
}
}
...
{isConditionTrue_0 = eventsFunctionContext.getOnceTriggers().triggerOnce(13098452);
}
