...
gdjs.BadPerfomanceCode.asyncCallback13897892 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtsExt__Share__Share.func(runtimeScene, "Передайте ссылку на игру на другое устройство:", "https://afrolovs.github.io/okko_runner/", "Передайте ссылку на игру на другое устройство", (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)), (runtimeScene) => (gdjs.BadPerfomanceCode.asyncCallback13897892(runtimeScene, asyncObjectsList)));
}
}
...
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(13893204);
}
}
if (isConditionTrue_0) {
