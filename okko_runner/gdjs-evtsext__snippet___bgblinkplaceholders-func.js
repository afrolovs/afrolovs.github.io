...
gdjs.evtsExt__Snippet___BGBlinkPlaceHolders.asyncCallback15674388 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.evtsExt__Snippet___BGBlinkPlaceHolders.asyncCallback15674388(runtimeScene, eventsFunctionContext, asyncObjectsList)));
}
}
...
};gdjs.evtsExt__Snippet___BGBlinkPlaceHolders.asyncCallback15673988 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(eventsFunctionContext.localVariables);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.evtsExt__Snippet___BGBlinkPlaceHolders.asyncCallback15673988(runtimeScene, eventsFunctionContext, asyncObjectsList)));
}
}
...
{isConditionTrue_0 = eventsFunctionContext.getOnceTriggers().triggerOnce(15673604);
}
...
};gdjs.evtsExt__Snippet___BGBlinkPlaceHolders.asyncCallback15673092 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(eventsFunctionContext.localVariables);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.evtsExt__Snippet___BGBlinkPlaceHolders.asyncCallback15673092(runtimeScene, eventsFunctionContext, asyncObjectsList)));
}
}
...
};gdjs.evtsExt__Snippet___BGBlinkPlaceHolders.asyncCallback15672692 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(eventsFunctionContext.localVariables);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.evtsExt__Snippet___BGBlinkPlaceHolders.asyncCallback15672692(runtimeScene, eventsFunctionContext, asyncObjectsList)));
}
}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = eventsFunctionContext.getOnceTriggers().triggerOnce(15672308);
}
if (isConditionTrue_0) {
...
};gdjs.evtsExt__Snippet___BGBlinkPlaceHolders.asyncCallback15671796 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(eventsFunctionContext.localVariables);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.evtsExt__Snippet___BGBlinkPlaceHolders.asyncCallback15671796(runtimeScene, eventsFunctionContext, asyncObjectsList)));
}
}
...
};gdjs.evtsExt__Snippet___BGBlinkPlaceHolders.asyncCallback15671340 = function (runtimeScene, eventsFunctionContext, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(eventsFunctionContext.localVariables);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.evtsExt__Snippet___BGBlinkPlaceHolders.asyncCallback15671340(runtimeScene, eventsFunctionContext, asyncObjectsList)));
}
}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = eventsFunctionContext.getOnceTriggers().triggerOnce(15670956);
}
if (isConditionTrue_0) {
gdjs.copyArray(eventsFunctionContext.getObjects("PH"), gdjs.evtsExt__Snippet___BGBlinkPlaceHolders.GDPHObjects1);
