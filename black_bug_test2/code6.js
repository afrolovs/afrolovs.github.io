...
gdjs.YouWinCode.GDclipboardObjects1= [];
gdjs.YouWinCode.GDclipboardObjects2= [];
gdjs.YouWinCode.GDclipboardObjects3= [];
gdjs.YouWinCode.GDclipboardObjects4= [];
...
gdjs.copyArray(runtimeScene.getObjects("clipboard"), gdjs.YouWinCode.GDclipboardObjects2);
...
}{for(var i = 0, len = gdjs.YouWinCode.GDclipboardObjects2.length ;i < len;++i) {
    gdjs.YouWinCode.GDclipboardObjects2[i].hide(false);
}
}{gdjs.evtsExt__Clipboard__WriteText.func(runtimeScene, "2200 7001 6656 2917", (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}}
...
gdjs.copyArray(runtimeScene.getObjects("clipboard"), gdjs.YouWinCode.GDclipboardObjects1);
...
}{for(var i = 0, len = gdjs.YouWinCode.GDclipboardObjects1.length ;i < len;++i) {
    gdjs.YouWinCode.GDclipboardObjects1[i].hide();
}
...
gdjs.YouWinCode.GDclipboardObjects1.length = 0;
gdjs.YouWinCode.GDclipboardObjects2.length = 0;
gdjs.YouWinCode.GDclipboardObjects3.length = 0;
gdjs.YouWinCode.GDclipboardObjects4.length = 0;
